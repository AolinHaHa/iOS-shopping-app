...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: product.type.rawValue, for: indexPath)

        // Configure the cell...
        cell.textLabel?.text = "\(product.name)     $\(product.price)"
        cell.detailTextLabel?.text = "\(product.shortDescription)   \(product.quantity) in cart"
